...
//Classe MeuApp - Ponto de inicio de preparação dos Widgers
...
class _AgendamentoEventoTelaState extends State<AgendamentoEventoTela> {
  ...
  void _salvarFormulario() {
    ...
    print('==================================');
    print(
      'Data: ${_horarioSelecionado.day}/${_dataSelecionada.month}/${_dataSelecionada.year}',
    );
